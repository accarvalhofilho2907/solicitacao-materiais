...
- **Item 114 — Importar Orçamento (leitura do PDF):** o drag-and-drop já foi entregue, mas a **extração dos itens do PDF** ainda erra para layouts diferentes do primeiro modelo. Há **2 modelos reais anexados** (FBM e Cofermeta) documentados no `Plano-Tecnico.md`; falta calibrar o parser para cada um (e decidir o que fazer com campos extras do Cofermeta: NCM, CST, %ICMS). É o único item funcional ainda pendente.
